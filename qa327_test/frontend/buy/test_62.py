...
"""
This file defines all requirement tests for R6.2.
R6.2 - The name of the ticket is shorter than 60 characters.
"""
# Mock a sample user
test_user = User(
...
class FrontEndBuyR6(BaseCase):
    ...
    def test_nameTooLong(self, *_):
        """
        This function tests that if the user enters a ticket name longer than 60 
        characters into the buy form, then an error message should be displayed
        on the homepage
        """
        ...
        self.type("#buy_form form div #name", "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa") # error: too long
