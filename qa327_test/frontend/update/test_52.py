...
"""
This file defines all requirement tests for R5.2.
...
class FrontEndUpdateR2(BaseCase):
    ...
    def test_nameTooLong(self, *_):
        ...
        form that is longer than 60 characters, then an error message is displayed in
        ...
        self.type("#update_form form div input#name", "test_update_nameaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa") # error: greater than 60 characters
