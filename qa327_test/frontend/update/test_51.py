...
class FrontEndUpdateR1(BaseCase):
    ...
    def test_nameNonAlphanumeric(self, *_):
        ...
        self.type("#update_form form div input#name", "test_update_name^") # error: non-alphanumeric
    ...
    def test_nameSpaceFirstChar(self, *_):
        ...
        # fill in name, quantity, price and date in the update form
        self.type("#update_form form div input#name", " test_update_name") # error: space as the first character
        self.type("#update_form form div input#quantity", int(test_tickets[0].quantity))
        self.type("#update_form form div input#price", float(test_tickets[0].price))
        self.type("#update_form form div input#date", test_tickets[0].date)
        self.click('#update_form form div input[type="submit"]')
    ...
    def test_nameSpaceLastChar(self, *_):
        ...
        # fill in name, quantity, price and date in the update form
        self.type("#update_form form div input#name", "test_update_name ") # error: space as the last character
        self.type("#update_form form div input#quantity", int(test_tickets[0].quantity))
        self.type("#update_form form div input#price", float(test_tickets[0].price))
        self.type("#update_form form div input#date", test_tickets[0].date)
        self.click('#update_form form div input[type="submit"]')
