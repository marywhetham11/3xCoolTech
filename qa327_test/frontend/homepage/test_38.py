...
"""
This file defines all requirement tests for R3.8.
R3.8 -  The homepage has a form for updating tickets 
...
class FrontEndHomepageR3(BaseCase):
    ...
    def test_updateForm(self, *_):
        """
        This function tests that if the user is logged in and is on the homepage,
        there is a form for updating tickets with fields name, quantity, price, expiration
        date
        """
